...
2. Скачай наш `.pkg` из последнего релиза.
3. Откройте пакет.
...
5. После этого скачайте наш `.pkg` из релизов проекта.
6. Да, реально, ещё раз переустанови наш драйвер pkg, даже если уже ставил его!
